...
// Điểm tối đa: 27 * 2 = 54
export const SAFE_THRESHOLD = 18; // <= 18 điểm: An toàn
export const MEDIUM_THRESHOLD = 36; // 19-36 điểm: Rủi ro trung bình
// > 36 điểm: Rủi ro cao

export const TEACHER_PASSWORD = 'admin'; // Mật khẩu duy nhất cho tất cả giáo viên
export const QUIZ_QUESTIONS: Question[] = [
  // Phần A: Hành vi sử dụng mạng
  {
    id: 'q1',
    section: 'Phần A: Hành vi sử dụng mạng',
    text: 'Bạn có thường xuyên bị thu hút bởi các tin nhắn tuyển dụng "việc nhẹ lương cao" và đã nhấn vào link để đăng ký hoặc tìm hiểu thêm không?',
    options: [
